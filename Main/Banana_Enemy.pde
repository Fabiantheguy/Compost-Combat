...
class Banana extends Enemy {
  ...
  PImage spriteSheetBanana = loadImage("Banana.png"); 
;       // 
  ...
  int cols = 6;
  int rows = 1; 
  int frameW =spriteSheetBanana. width / cols;
  int frameH = spriteSheetBanana. height / rows; 
  ...
  int frameCounter = 0;
    ...
    int index; 
      //for (int i =0; i < cols; i++){
       // frames[index++] = spriteSheetBanana.get(i * frameW,  frameH, frameW, frameH);
     // }
